            ...
            <div class="bg-white dark:bg-gray-800 overflow-hidden shadow-xl sm:rounded-lg p-6 lg:p-8">
                        ...
                        <form method="POST" action="{{ route('students.update',$student->id) }}" class="max-w-sm mx-auto">
                            ...
                            <div class="mb-5">
                                ...
                                <input type="number" name="age" id="age" value="{{ old('age',default: $student->age) }}"class="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full p-2.5 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-blue-500 dark:focus:border-blue-500" required>
                            </div>
